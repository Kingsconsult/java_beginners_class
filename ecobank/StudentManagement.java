...
public class StudentManagement {
    ...
    public static void main(String[] args) {
        ...
        // Student hardcodedStudent = new Student(1, "Vivian Nzekwe",
        // "vivian@gmail.com");
    ...
    private static void searchStudentByName(Scanner scanner) {
        System.out.println("Enter the students name you want to search");
    ...
    // serach student by email
    private static void searchStudentByEmail(Scanner scanner) {
        System.out.println("Enter the students email you want to search");
