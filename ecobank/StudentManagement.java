...
public class StudentManagement {
    ...
    private static void retrieveAStudent(Scanner scanner) {
        System.out.println("Enter the student's Id you want to retrieve"); 
    ...
    private static void search(Scanner scanner){
       List<Student> results = new ArrayList<>();
        Long longInput ;
        System.out.println("Enter your search input e.g id(1), name(Prosper), email(prosper@gmail.com)");
